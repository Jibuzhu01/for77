...
def output(name, roi1, out_path, IncI, CI, RVD, mean_surface_distance, centroid_distance, dice_coefficient, hausdorff_distance_95):
    fr = open(out_path, 'a')
    out_str = name + ',' + roi1 + ',' + str(IncI) + ',' + str(CI) + ',' + str(RVD) + ',' + str(mean_surface_distance) + ',' + str(centroid_distance) + ',' + str(dice_coefficient) + ',' + str(hausdorff_distance_95)
    print(out_str, file=fr)
    fr.close()

def calc(name, roi1, out_path, mask_r1, mask_r2, tran_mat=np.array([1, 1, 1])):
    # 计算全部的指标
    ...
    output(name, roi1, out_path, IncI, CI, RVD, mean_surface_distance, centroid_distance, dice_coefficient, hausdorff_distance_95)
def main(path1, path2, out_path, roi1="CTV_PRE", roi2="CTV_SD", vision=False):
    ...
    name = path1.split("/")[-1]
    calc(name, roi1, out_path, new_mask_r1, new_mask_r2, new_tran_mat)
...
if __name__ == "__main__":
    ...
    tea_path = "/Users/guqiqi/Downloads/zhaoyaru/PUMCH_Zhaoyaru_case4pre"
    stu_path = "/Users/guqiqi/Downloads/zhaoyaru/PUMCH_Zhaoyaru_case4post"
    out_path = "/Users/guqiqi/Downloads/coderesult/Augcase5.csv"
    main(stu_path, tea_path, out_path, roi1="CTV-U", roi2="CTV-U", vision=False)
